...
from models import Game, User, Tag, GameSimilarity  # Importiere alle relevanten Modelle
...
if not DATABASE_URL:
    raise ValueError("❌ ERROR: DATABASE_URL is not set! Make sure it is configured in your environment.")
