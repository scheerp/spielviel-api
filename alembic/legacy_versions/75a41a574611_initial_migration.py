...
def upgrade() -> None:
    ...
    op.drop_index(
        "ix_game_similarities_game_id", table_name="game_similarities", if_exists=True
    )
    op.drop_index(
        "ix_game_similarities_id", table_name="game_similarities", if_exists=True
    )
    op.drop_index(
        "ix_game_similarities_similar_game_id",
        table_name="game_similarities",
        if_exists=True,
    )
...
def downgrade() -> None:
    ...
    op.create_index(
        "ix_tags_german_normalized_tag", "tags", ["german_normalized_tag"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "similarity_score", sa.DOUBLE_PRECISION(precision=53), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["game_id"], ["games.id"], name="game_similarities_game_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["similar_game_id"],
            ["games.id"],
            name="game_similarities_similar_game_id_fkey",
        ),
    ...
    op.create_index(
        "ix_game_similarities_id", "game_similarities", ["id"], unique=False
    )
    op.create_index(
        "ix_game_similarities_game_id", "game_similarities", ["game_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["game_id"], ["games.id"], name="game_tags_game_id_fkey"
        ),
